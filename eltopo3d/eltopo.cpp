                               ...
                               struct ElTopoMesh* outputs )
{
    ...
    construction_parameters.m_collision_safety = 0 != general_options->m_collision_safety;
    construction_parameters.m_allow_topology_changes = 0 != options->m_allow_topology_changes;
    construction_parameters.m_perform_improvement = 0 != options->m_perform_improvement;
                       ...
                       double *out_dt )
{
    ...
    DynamicSurface dynamic_surface(vs,
                                   ...
                                   0 != general_options->m_collision_safety,
                                   0 != general_options->m_verbose );
