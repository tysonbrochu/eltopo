...
using namespace ElTopo;
    ...
    unsigned long to_ulong(size_t a)
    {
      assert(a < ULONG_MAX);
...
bool ImpactZoneSolver::inelastic_projection( const ImpactZone& iz )
{
    ...
    Array1d inv_masses;
    inv_masses.reserve(to_ulong(3*n));
    Array1d column_velocities;
    column_velocities.reserve(to_ulong(3*n));
