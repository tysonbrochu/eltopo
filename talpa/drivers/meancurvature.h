...
public:
    ...
    ///
    static void vertex_mean_curvature_normal( size_t vertex_index, const SurfTrack& surf, ElTopo::Vec3d& out );
    
    /// Compute MC * normal at a vertex and return the sum of weights used (for computing the time step restriction)
    ///
    static void vertex_mean_curvature_normal( size_t vertex_index, const SurfTrack& surf, ElTopo::Vec3d& out, double& weight_sum );
